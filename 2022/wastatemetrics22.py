...
def statePlyData():
    ...
    state = pd.read_excel('../ComputerScienceEducationDataSummaryReport21-22.xlsx','State')
    print (state.dtypes)
...
def SchoolEnrollmentData():
     ...
     schoolCSEnrollmentT = pd.read_excel('../ComputerScienceEducationDataSummaryReport21-22.xlsx','School')
     ...
     schoolCSEnrollment.to_csv("SchoolCSEEnrollmentOnly_2022.csv")

def teacherPlyData():
    teacher = pd.read_excel('../ComputerScienceEducationDataSummaryReport21-22.xlsx','Educators')
    print (teacher.dtypes)
    teacher.reset_index()

    teacher.columns=['schoolYear','LEA Code','LEA Name','School Code','School Name','Category','Subcategory','Total Count','Count','Percent']
    teacher.to_csv('2022_Comp Sci Educator Info.csv')

     # Not actually used
def teacherPlyDataOriginal():
    ...
    teacher_df.to_csv("xxxx_teacher_t.csv") 
...
# These are not used for 2021-22
